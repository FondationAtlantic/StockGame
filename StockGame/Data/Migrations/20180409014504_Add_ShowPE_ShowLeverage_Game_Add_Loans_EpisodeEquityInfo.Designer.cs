...
namespace StockGame.Data.Migrations
{
    ...
    [Migration("20180409014504_Add_ShowPE_ShowLeverage_Game_Add_Loans_EpisodeEquityInfo")]
    partial class Add_ShowPE_ShowLeverage_Game_Add_Loans_EpisodeEquityInfo
    {
                    ...
                    b.OwnsOne("StockGame.Models.EpisodeRange", "AllowJoinEpisodeRange", b1 =>
                        {
                            ...
                            b1.HasOne("StockGame.Models.Game")
                                .WithOne("AllowJoinEpisodeRange")
                                .HasForeignKey("StockGame.Models.EpisodeRange", "GameId")
                                .OnDelete(DeleteBehavior.Cascade);
                        });
                    ...
                    b.OwnsOne("StockGame.Models.EpisodeRange", "ShowLeverageEpisodeRange", b1 =>
                        {
                            ...
                            b1.HasOne("StockGame.Models.Game")
                                .WithOne("ShowLeverageEpisodeRange")
                                .HasForeignKey("StockGame.Models.EpisodeRange", "GameId")
                                .OnDelete(DeleteBehavior.Cascade);
                        });
                    ...
                    b.OwnsOne("StockGame.Models.EpisodeRange", "ShowPriceEarningsEpisodeRange", b1 =>
                        {
                            ...
                            b1.HasOne("StockGame.Models.Game")
                                .WithOne("ShowPriceEarningsEpisodeRange")
                                .HasForeignKey("StockGame.Models.EpisodeRange", "GameId")
                                .OnDelete(DeleteBehavior.Cascade);
                        });
                });
